<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $result = mysqli_query($conexao, "INSERT INTO diretriz(descricao) VALUES('$descricao')");
...
<body>
    <main>
        <div class="principal">
            ...
            <br>
            <form action="diretriz_cadastro.php" method="POST" id="form" style="background-color:#F9FBFD;">
                <fieldset>
                    <legend style="text-align: center;"><strong>Diretriz</strong></legend><br>
                    ...
                    <div class="centralizar">
                        <button class="btao-login"><a href="diretriz.php" style="color:black">Cancelar</a></button>
